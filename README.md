...
`spectrum live` continuously redraws the sweep using braille-style graph cells for a denser terminal preview. This is still a received-power sweep view, not an IQ or waterfall analyzer.
